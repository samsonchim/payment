...
export function Preloader({ onComplete, duration = 2000 }: PreloaderProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col items-center justify-center" style={{ backgroundColor: 'hsl(0, 0%, 100%)' }}>
      {/* Main Logo/Icon */}
      ...
      >
        <div 
          ...
          style={{ 
            width: `${progress}%`,
            background: `linear-gradient(to right, hsl(142, 76%, 36%), hsl(142, 76%, 45%))`
          }}
        ></div>
      </div>
      ...
      <div className="absolute bottom-8 text-center">
        <p style={{ color: 'hsl(142, 76%, 30%)' }} className="text-sm">
          Developed by{' '}
          <a 
